...
<pre>
<strong>Input:</strong> nums = <span><code>[4,6,5,9,3,7]</code></span>, l = <span><code>[0,0,2]</code></span>, r = <span><code>[2,3,5]</code></span>
<strong>Output:</strong> <span><code>[true,false,true]</code></span>
...
In the 2<sup>nd</sup> query, the subarray is <span><code>[5,9,3,7]. This</code></span> can be rearranged as <span><code>[3,5,7,9]</code></span>, which is an arithmetic sequence.</pre>
...
<div><div>Related Topics</div><div><li>Array</li><li>Sorting</li></div></div><br><div><li>👍 828</li><li>👎 89</li></div>